/* gpaste-1.0.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "GPaste", gir_namespace = "GPaste", gir_version = "1.0", lower_case_cprefix = "g_paste_")]
namespace GPaste {
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_client_get_type ()")]
	public class Client : GLib.Object {
		[CCode (has_construct_function = false)]
		public Client ();
		public void add (string text) throws GLib.Error;
		public void backup_history (string name) throws GLib.Error;
		public void @delete (uint32 index) throws GLib.Error;
		public void delete_history (string name) throws GLib.Error;
		public void empty () throws GLib.Error;
		public string get_element (uint32 index) throws GLib.Error;
		[CCode (array_length = false, array_null_terminated = true)]
		public string[] get_history () throws GLib.Error;
		[CCode (array_length = false, array_null_terminated = true)]
		public string[] list_histories () throws GLib.Error;
		public void reexecute () throws GLib.Error;
		public void select (uint32 index) throws GLib.Error;
		public void switch_history (string name) throws GLib.Error;
		public void track (bool state) throws GLib.Error;
		public signal void changed ();
		public signal void show_history ();
	}
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_clipboard_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_clipboards_manager_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h")]
	[Compact]
	public class Connection {
	}
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_history_get_type ()")]
	public class History : GLib.Object {
		...
		public void @delete ();
		public void empty ();
		public unowned GPaste.Item @get (uint index);
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_image_item_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_item_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_keybinder_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_keybinding_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_settings_get_type ()")]
	public class Settings : GLib.Object {
		[CCode (has_construct_function = false)]
		public Settings ();
		public uint get_element_size ();
		public bool get_fifo ();
		...
		public void set_fifo (bool value);
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_text_item_get_type ()")]
	public class TextItem : GPaste.Item {
		[CCode (has_construct_function = false)]
		public TextItem (string text);
	}
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_uris_item_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", type_id = "g_paste_xcb_wrapper_get_type ()")]
	...
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", cprefix = "G_PASTE_KEYBINDINGS_")]
	public enum Keybindings {
		SHOW_HISTORY,
		PASTE_AND_POP,
		LAST_KEYBINDING
	}
	[CCode (cheader_filename = "gpaste-client.h,gpaste.h", instance_pos = 0.9)]
