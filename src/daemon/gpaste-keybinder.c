...
static void
on_keybinding_activated (GPasteKeybindingProvider *provider G_GNUC_UNUSED,
                         const gchar              *id,
                         gpointer                  user_data)
{
 ...
 * @provider: a #GPasteKeybindingProvider instance
 *
                       ...
                       GPasteKeybindingProvider *provider)
{
    ...
    g_return_val_if_fail (G_PASTE_IS_KEYBINDING_PROVIDER (provider), NULL);
