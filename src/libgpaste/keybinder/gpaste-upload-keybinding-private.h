...
#ifndef __G_PASTE_UPLOAD_KEYBINDING_PRIVATE_H__
#define __G_PASTE_UPLOAD_KEYBINDING_PRIVATE_H__
...
struct _GPasteUploadKeybindingClass
{
...
#endif /*__G_PASTE_UPLOAD_KEYBINDING_PRIVATE_H__*/
