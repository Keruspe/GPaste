 ...
 *
 * Create a new instance of a #GPasteItem subclass. This is a GType-based factory
 * for the abstract base, not a constructor, so it is skipped for introspection.
 *
