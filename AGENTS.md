...
- When updating source files in this repository, keep the `AGENTS.md` covering them up to date — this one, or the one beside the code (see Architecture) — to reflect any new patterns, rules, or architectural decisions introduced.
